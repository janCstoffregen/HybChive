...
int main(int argc, char *argv[]){
    ...
    //printf"\n 10.1 key: %d, begin: %d, end: %d, n: %d, searchForInt_host: %d\n",ikey,begin,end,n,searchForInt_Host[0]);
    ...
    */
    ...
    //Put your algorithm here!!
        ...
        // Read back the results from the device to verify the output
            //
        //err = clEnqueueReadBuffer( commands, A_device, CL_TRUE, 0, sizeof(double) * (end-begin), A_host, 0, NULL, NULL );  
        //    if (err != CL_SUCCESS)
        //    {
